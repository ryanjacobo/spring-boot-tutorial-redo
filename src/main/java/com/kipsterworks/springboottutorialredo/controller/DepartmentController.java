...
import com.kipsterworks.springboottutorialredo.error.DepartmentNotFoundException;
...
public class DepartmentController {
    ...
    public Department fetchDepartmentListId(@PathVariable("id")Long departmentId) throws DepartmentNotFoundException {
